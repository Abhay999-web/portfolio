...
import pic from "../../public/Abhay.jpg";
    ...
    <div name="Home" className="max-w-screen-2*1 container mx-auto px-4 md:px-20 my-20">
       <div className='flex flex-col md:flex-row'> 
            <div className='md:w-1/2 mt-12 md:mt-24 space-y-2 order-2 md:order-1'>
                ...
                <br />
                <div>
                    <h1 className='font-bold text-2xl md:text-4xl '>My name is <span className='text-red-700 font-bold text-2xl md:text-4xl' >Abhay Pratap Singh</span></h1>
                </div>
                <br/>
                <p className='text-2xl text-justify'>I am a Full Stack Web Developer who loves to create <span>Reliable, Scalable </span>and<span> Efficient</span> problems of Today and Tomorrow.
                </p>
                <br/>
                {/* <span className='text-red-700 font-bold text-2xl md:text-4xl'>Software Developer</span> */}
                <ReactTyped
                ...
                <div className='space-y-2'>
                <h1 className='flex text-2xl font-bold'> Currently working on</h1>
